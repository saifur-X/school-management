...
export default function Dashboard() {
  ...
  // ডে টাইপ স্টেট: 'Class Day' | 'Exam Day' | 'Class Off' | 'Holiday'
  ...
  // যদি ডিফল্ট ক্লাস অ্যাক্টিভ লিস্টে না থাকে, প্রথম অ্যাক্টিভ ক্লাসটি স্বয়ংক্রিয়ভাবে সিলেক্ট হবে
  useEffect(() => {
  ...
  const loadAttendance = async (cls, date, mode = attendanceMode) => {
    ...
    // লোড ডে টাইপ (Database বা LocalStorage)
    try {
  ...
  // ফিক্সড ফিল্টারিং: এখন স্টুডেন্টদের স্ট্যাটাস 'active', 'Active' বা নাল যাই থাকুক না কেন লিস্টে দেখাবে
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-slate-950 animated-mesh-bg text-slate-100 font-sans relative overflow-hidden">
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto w-full relative z-10">
        ...
        {/* ==============================================================
            ADVANCED ATTENDANCE SYSTEM (FIXED & DAY-TYPE BUTTONS ADDED)
            ============================================================== */}
        {activeTab === 'attendance' && (
          <div className="space-y-6 animate-fade-in w-full">
            ...
            <div className="bg-slate-900/70 border border-white/10 p-4 rounded-3xl shadow-xl backdrop-blur-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              {/* ৪টি অপশন বাটন: Class Day, Exam Day, Class Off, Holiday */}
