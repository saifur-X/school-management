...
export default function Dashboard() {
  ...
  // লাইভ ক্লক ও রিয়েলটাইম তারিখ স্টেট
  ...
  // লাইভ ঘড়ি প্রতি সেকেন্ডে আপডেট হওয়ার জন্য ইফেক্ট
  useEffect(() => {
      ...
      <div className="min-h-screen animated-mesh-bg text-slate-100 font-sans p-6 md:p-10 relative overflow-hidden">
        <div className="max-w-6xl mx-auto space-y-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-900/70 border border-white/10 p-6 rounded-3xl flex flex-col justify-center backdrop-blur-2xl"><p className="text-xs text-slate-400 uppercase tracking-widest font-bold">Current Dues (Arrears)</p><h3 className="text-4xl font-black text-rose-400 mt-2">₹{totalDue}</h3></div>
          </div>
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen animated-mesh-bg text-slate-100 font-sans relative overflow-hidden">
      ...
      {/* অ্যানিমেটেড কালারফুল ব্যাকগ্রাউন্ড ও নিওন গ্লো সিএসএস */}
      <style dangerouslySetInnerHTML={{ __html: `
        .scrollbar-hide::-webkit-scrollbar { display: none; }
        .scrollbar-hide { -ms-overflow-style: none; scrollbar-width: none; }

        /* ডাইনামিক লাইভ গ্রেডিয়েন্ট ব্যাকগ্রাউন্ড */
        ...
        /* নিওন গ্লো বাটন ও অ্যাকসেন্ট ইফেক্ট */
        .btn-glow-blue {
      ...
      {/* রঙিন ভাইব্র্যান্ট ফ্লুয়িড অরবস (Eye-pleasing background effects) */}
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto w-full relative z-10">
        ...
        {activeTab === 'attendance' && (
          <div className="space-y-6 animate-fade-in w-full">
            <h2 className="text-2xl font-bold border-b border-white/10 pb-4">Daily Attendance System</h2>
            <div className="bg-slate-900/70 p-6 rounded-3xl border border-white/10 flex flex-wrap gap-4 items-end backdrop-blur-2xl">
               <div>
            ...
            {attendanceClass && (
              <div className="bg-slate-900/70 border border-white/10 rounded-3xl p-6 shadow-2xl backdrop-blur-2xl">
