...
export default function Dashboard() {
  ...
  // কমন কালারফুল সিএসএস স্টাইল যা সকল পোর্টালে থাকবে
  const sharedGlobalStyle = (
    <style dangerouslySetInnerHTML={{ __html: `
      ...
      /* স্টাইলিশ কালারফুল গ্রেডিয়েন্ট ফন্ট */
      .school-brand-title {
  ...
  // ==============================================================
  // STUDENT PORTAL VIEW (COLORFUL ANIMATED BACKGROUND & FULL BRANDING)
  // ==============================================================
  if (studentSession) {
    ...
    return (
      <div className="min-h-screen bg-slate-950 animated-mesh-bg text-slate-100 font-sans p-6 md:p-10 relative overflow-hidden">
        ...
        {/* ব্যাকগ্রাউন্ড অরোরা গ্লো ইফেক্টস */}
        ...
        <div className="max-w-6xl mx-auto space-y-8 relative z-10">
          ...
          {/* স্টুডেন্ট পোর্টাল হেডার: স্টাইলিশ কালারফুল নাম, ঠিকানা ও কন্টাক্ট */}
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-3 mt-2 text-xs text-slate-300 font-medium">
                  ...
                  {school.phone && (
                    <span className="flex items-center gap-1 bg-white/5 px-2.5 py-0.5 rounded-full border border-white/10">
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-slate-950 animated-mesh-bg text-slate-100 font-sans relative overflow-hidden">
      ...
      {/* SIDEBAR NAVIGATION (WITH STYLISH SCHOOL NAME & COMPLETE CONTACT) */}
      <aside className="w-full md:w-80 bg-slate-900/80 backdrop-blur-2xl border-r border-white/10 p-6 flex flex-col justify-between relative z-20 shadow-2xl">
        <div>
          ...
          <div className="p-4 rounded-3xl bg-slate-950/70 border border-white/10 mb-6 shadow-inner backdrop-blur-md">
            ...
            {/* স্কুলের ঠিকানা ও যোগাযোগ ডিটেইলস */}
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto w-full relative z-10">
        ...
        {/* টপ গ্লোয়িং হেডার ব্যানার: স্কুলের নাম, ঠিকানা, ফোন ও লাইভ ঘড়ি */}
          ...
          <div className="space-y-6 animate-fade-in w-full">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-white/10 pb-5 gap-4">
              <div>
                ...
                <p className="text-xs text-slate-300 mt-1">বারকোড স্ক্যানার, WhatsApp নোটিফিকেশন ও মাসিক রেজিস্টার।</p>
              </div>
            ...
            {attendanceView === 'daily' && (
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3.5">
                ...
                <div className="bg-amber-950/30 border border-amber-500/30 p-4 rounded-2xl backdrop-blur-xl">
                  <p className="text-[10px] text-amber-400 font-bold uppercase tracking-wider">Late</p>
              ...
              <div className="bg-slate-900/70 border border-white/10 rounded-3xl shadow-2xl overflow-hidden relative backdrop-blur-2xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 md:p-10">
                  ...
                  <div className="bg-slate-950/70 border border-white/10 p-6 rounded-2xl hover:border-white/20 transition flex flex-col">
                    <h3 className="text-xs uppercase tracking-widest font-bold text-slate-500 mb-5 border-b border-white/10 pb-2">Administration</h3>
