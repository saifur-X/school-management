...
export default function Dashboard() {
  ...
  // সেশন অথেন্টিকেশন চেক (Admin, Teacher ও Student আলাদাভাবে সমর্থিত)
  useEffect(() => {
  ...
  // শিক্ষক বা অ্যাডমিন অনুযায়ী মেনু লিস্ট
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-2xl flex items-center gap-4">
                ...
                <div><p className="text-xs text-slate-400 font-semibold uppercase tracking-wider">{teacherSession ? 'My Role' : 'Total Staff'}</p><h3 className="text-2xl font-black text-purple-400 mt-1">{teacherSession ? teacherSession.role : staffList.length}</h3></div>
              </div>
              <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-2xl flex items-center gap-4">
          ...
          <div className="space-y-6 animate-fade-in w-full">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-slate-800 pb-4 gap-4">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">শিক্ষক ও স্টাফদের অ্যাকাউন্ট ম্যানেজ করুন। শিক্ষকরা তাদের মোবাইল ও পাসওয়ার্ড দিয়ে লগইন পেজ থেকে প্রবেশ করতে পারবেন।</p>
              </div>
