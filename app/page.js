...
export default function Dashboard() {
  ...
  // Attendance System States & Day Type
  ...
  const sharedGlobalStyle = (
    <style dangerouslySetInnerHTML={{ __html: `
      ...
      .school-brand-title {
        ...
        background: linear-gradient(135deg, #38bdf8 0%, #ec4899 50%, #facc15 100%);
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-slate-950 animated-mesh-bg text-slate-100 font-sans relative overflow-hidden">
          ...
          <div className="bg-slate-900/90 border border-white/10 p-6 md:p-8 rounded-3xl w-full max-w-4xl shadow-2xl relative my-8 backdrop-blur-2xl">
            ...
            <form onSubmit={handleSaveStudent} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div><label className="text-xs text-slate-300 mb-2 block">National ID</label><input type="text" name="aadharNo" value={formData.aadharNo} onChange={handleInputChange} className="w-full bg-slate-950 border border-slate-800 px-4 py-3 rounded-xl text-white outline-none focus:border-blue-500" /></div>
        ...
        <div className="fixed inset-0 bg-slate-950/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900/90 border border-white/10 p-6 md:p-8 rounded-3xl max-w-md w-full shadow-2xl relative backdrop-blur-2xl">
            ...
            <form onSubmit={handleSaveStaff} className="space-y-4">
              ...
              <div>
                <label className="text-xs text-slate-300 block mb-1 font-semibold">Login Access Permission</label>
                <select 
                  value={staffData.status || 'Active'} 
                  onChange={e => setStaffData({...staffData, status: e.target.value})} 
                  className="w-full bg-slate-950 border border-slate-700 p-3 rounded-xl text-white text-sm outline-none focus:border-purple-500 font-bold"
                >
                  <option value="Active">🟢 Login Access Allowed (Active)</option>
                  <option value="Inactive">🔴 Login Access Blocked (Inactive)</option>
                </select>
              </div>
          ...
          <div className="bg-slate-900/90 border border-white/10 p-6 md:p-8 rounded-3xl max-w-lg w-full shadow-2xl relative backdrop-blur-2xl">
            ...
            <form onSubmit={handleSaveNotice} className="space-y-4">
              <div>
                ...
                <input type="text" value={noticeFormData.title} onChange={e => setNoticeFormData({...noticeFormData, title: e.target.value})} className="w-full bg-slate-950 border border-slate-700 p-3 rounded-xl text-white text-sm outline-none focus:border-amber-500 font-bold" placeholder="e.g. Eid Vacation Notice" required/>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
      ...
      {/* 4. OFFICIAL NOTICE LETTERHEAD PRINT MODAL */}
      ...
      {/* 5. STATUS CHANGE / TRANSFER OUT MODAL */}
      {statusModalStudent && (
        <div className="fixed inset-0 bg-slate-950/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900/90 border border-white/10 p-6 rounded-3xl max-w-sm w-full shadow-2xl relative backdrop-blur-2xl">
            ...
            <div className="space-y-4">
              <div className="p-3 bg-slate-950 rounded-2xl text-xs text-slate-300">
              ...
              <div>
                ...
                <select value={statusAction} onChange={e => setStatusAction(e.target.value)} className="w-full bg-slate-950 border border-slate-700 p-2.5 rounded-xl text-white text-sm">
              ...
              {statusAction === 'Transferred' && (
                <div>
                  ...
                  <input type="text" value={statusReason} onChange={e => setStatusReason(e.target.value)} placeholder="e.g. Relocation, Parent Request" className="w-full bg-slate-950 border border-slate-700 p-2.5 rounded-xl text-white text-sm" />
                </div>
              )}
              <button onClick={handleChangeStatus} disabled={isProcessing} className="btn-glow-amber w-full bg-amber-600 hover:bg-amber-500 py-3 rounded-2xl text-sm font-bold transition flex justify-center items-center gap-2 mt-4 text-white">
        ...
        <div className="fixed inset-0 bg-white text-slate-900 z-50 p-6 overflow-y-auto print:p-0">
          ...
          <div className="max-w-2xl mx-auto border-4 border-double border-slate-900 p-10 rounded-none bg-white relative">
             ...
             <div className="flex justify-between items-end mt-20 px-4 pt-10">
               <div className="text-center"><p className="font-bold text-xs">{new Date().toLocaleDateString()}</p><div className="w-32 border-t border-slate-900 mt-1"></div><p className="text-[10px] text-slate-600 uppercase mt-1 font-bold">Date of Issue</p></div>
      ...
      {editingTx && (
        <div className="fixed inset-0 bg-slate-950/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900/90 border border-white/10 p-6 rounded-3xl max-w-sm w-full shadow-2xl relative backdrop-blur-2xl">
            ...
            <div className="space-y-4">
              <div><label className="text-xs text-slate-400 block mb-1">Fee Type</label><input type="text" value={editingTx.fee_type} disabled className="w-full bg-slate-950 border border-slate-800 p-2.5 rounded-xl text-slate-500 text-sm" /></div>
              <div><label className="text-xs text-slate-400 block mb-1">Discount Amount (₹)</label><input type="number" value={editingTx.discount} onChange={(e) => setEditingTx({...editingTx, discount: e.target.value})} className="w-full bg-slate-950 border border-slate-700 p-2.5 rounded-xl text-white text-sm" /></div>
              <div><label className="text-xs text-slate-400 block mb-1">Actually Paid Amount (₹)</label><input type="number" value={editingTx.paid_amount} onChange={(e) => setEditingTx({...editingTx, paid_amount: e.target.value})} className="w-full bg-emerald-950/30 border border-emerald-500/50 p-2.5 rounded-xl text-emerald-400 font-bold text-sm" /></div>
      ...
      {/* 8. STUDENT CONTACT DETAILS MODAL */}
      {contactModalStudent && (
        <div className="fixed inset-0 bg-slate-950/85 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900/90 border border-white/10 p-6 rounded-3xl max-w-sm w-full space-y-4 shadow-2xl relative backdrop-blur-2xl">
            ...
            <div className="text-center">
              <img src={contactModalStudent.photo_url || 'https://via.placeholder.com/150'} alt="" className="w-20 h-20 rounded-full mx-auto object-cover border-2 border-blue-500 mb-3 shadow-[0_0_20px_rgba(59,130,246,0.4)]" />
            ...
            <div className="space-y-3 bg-slate-950/80 p-4 rounded-2xl border border-white/5 text-xs text-slate-300">
            ...
            {contactModalStudent.phone && (
              <a href={`tel:${contactModalStudent.phone}`} className="btn-glow-emerald w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 rounded-2xl flex items-center justify-center gap-2 text-xs transition"><PhoneCall size={16} /> কল করুন</a>
            )}
          </div>
        </div>
      )}

      {/* 9. PRINTABLE MONEY RECEIPT MODAL */}
      {receiptData && (
        <div className="fixed inset-0 bg-white text-slate-900 z-50 p-6 overflow-y-auto print:p-0">
      ...
      <aside className="w-full md:w-80 bg-slate-900/80 backdrop-blur-2xl border-r border-white/10 p-6 flex flex-col justify-between relative z-20 shadow-2xl">
        <div>
          <div className="p-4 rounded-3xl bg-slate-950/70 border border-white/10 mb-6 shadow-inner backdrop-blur-md">
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto w-full relative z-10">
        ...
        {/* টপ ব্যানার */}
        <div className="bg-slate-900/80 border border-white/10 p-5 md:p-6 rounded-3xl mb-8 shadow-2xl backdrop-blur-2xl flex flex-col lg:flex-row justify-between items-start lg:items-center gap-5">
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap items-center gap-3.5 text-xs text-slate-300 font-medium">
              <span className="flex items-center gap-1"><MapPin size={13} className="text-cyan-400"/> {school.address || 'Location Address'}</span>
              <span className="flex items-center gap-1 font-mono text-emerald-300"><PhoneCall size={13} className="text-emerald-400"/> {school.phone || 'Phone'}</span>
              <span className="flex items-center gap-1 text-amber-300"><Mail size={13} className="text-amber-400"/> {school.email || 'Email'}</span>
            </div>
          </div>

          <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-2xl border border-purple-500/40 bg-purple-500/15 text-purple-200 text-xs font-mono font-bold shadow-[0_0_20px_rgba(168,85,247,0.3)] backdrop-blur-md shrink-0">
        ...
        {activeTab === 'attendance' && (
          <div className="space-y-6 animate-fade-in w-full">
            ...
            <div className="bg-slate-900/70 border border-white/10 p-4 rounded-3xl shadow-xl backdrop-blur-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  ...
                  <table className="w-full text-left min-w-[700px]">
                    ...
                    <tbody className="divide-y divide-white/5 text-sm">
                      ...
                      {currentAttendanceTargetList.length === 0 && (
                        <tr><td colSpan="4" className="text-center py-10 text-slate-500 font-semibold">এই ক্লাসে কোনো সক্রিয় স্টুডেন্ট খুঁজে পাওয়া যায়নি।</td></tr>
                      )}
                    </tbody>
                  </table>
                </div>
              ...
              <div className="bg-slate-900/70 border border-white/10 rounded-3xl p-6 shadow-2xl backdrop-blur-2xl space-y-4">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-white/10 pb-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">৭৫% উপস্থিতি নিয়ম ও পার্সেন্টেজ মনিটরিং।</p>
                  </div>
                  ...
                  <tbody className="divide-y divide-white/5 text-sm">
                    {getFilteredStudents().map((st) => (
                      <tr key={st.id} className="hover:bg-white/5 transition">
                        ...
                        <td className="p-4 cursor-pointer" onClick={() => setContactModalStudent(st)}>
                          <p className="font-bold text-white hover:text-cyan-400 transition flex items-center gap-1.5">{st.name} <PhoneCall size={12} className="text-slate-500"/></p>
          ...
          <div className="space-y-6 animate-fade-in w-full">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-white/10 pb-4 gap-4">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">শিক্ষক ও স্টাফদের অ্যাকাউন্ট পরিচালনা, লগইন পারমিশন এবং হোয়াটসঅ্যাপে লগইন তথ্য পাঠান।</p>
              </div>
              ...
              <table className="w-full text-left min-w-[850px]">
                <thead className="bg-slate-800/50 text-slate-400 text-xs uppercase tracking-wider">
                  <tr className="border-b border-white/10">
                    ...
                    <th className="p-4 text-center">Send to WhatsApp</th>
                    <th className="p-4 text-center">Actions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-white/5 text-sm">
                    ...
                    return (
                      <tr key={stf.id} className="hover:bg-white/5 transition">
                        ...
                        <td className="p-4 text-center">
                          <button 
                            type="button"
                            onClick={() => handleToggleStaffLoginAccess(stf)}
                            disabled={isProcessing}
                            className={`px-3 py-1.5 rounded-xl text-xs font-black inline-flex items-center gap-1.5 transition ${isStaffActive ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 hover:bg-emerald-500/30' : 'bg-rose-500/20 text-rose-300 border border-rose-500/40 hover:bg-rose-500/30'}`}
                            title="Click to toggle login access"
                          >
                            <Power size={13} className={isStaffActive ? 'text-emerald-400' : 'text-rose-400'} />
                            {isStaffActive ? 'Access ON' : 'Access OFF'}
                          </button>
                        </td>
                        ...
                        <td className="p-4 text-center">
                          {waCredLink ? (
                            <a 
                              ...
                              target="_blank" 
                              rel="noopener noreferrer"
                              className="btn-glow-emerald bg-emerald-600/20 hover:bg-emerald-600 hover:text-white text-emerald-300 border border-emerald-500/40 px-3.5 py-1.5 rounded-xl text-xs font-bold inline-flex items-center gap-1.5 transition"
                            >
                  ...
                  {staffList.length === 0 && (
                    <tr><td colSpan="6" className="text-center py-10 text-slate-500 font-semibold">কোনো স্টাফ রেকর্ড পাওয়া যায়নি।</td></tr>
                  )}
                </tbody>
              </table>
            </div>
                  ...
                  <div className="lg:col-span-8 space-y-6">
                    ...
                    <div className="bg-slate-900/70 border border-white/10 p-6 rounded-3xl shadow-xl space-y-6 backdrop-blur-2xl">
                      ...
                      <div>
                        ...
                        <input type="number" placeholder="Enter Cash/Online Amount" value={erpPaidAmount} onChange={(e) => setErpPaidAmount(e.target.value)} className="w-full bg-slate-950 border border-emerald-500/50 p-5 rounded-2xl text-emerald-400 font-black text-2xl outline-none focus:border-emerald-400 shadow-inner" />
                      </div>
              ...
              <div className="bg-slate-900/70 border border-white/10 rounded-3xl shadow-2xl overflow-hidden relative backdrop-blur-2xl">
                ...
                <div className="px-6 md:px-10 pb-8 relative -mt-16 flex flex-col md:flex-row gap-6 items-center md:items-end border-b border-white/10">
                  ...
                  <div className="text-center md:text-left flex-1 pb-2">
                    <h1 className="text-3xl font-black school-brand-title tracking-tight">{school.school_name || 'School Name Not Set'}</h1>
