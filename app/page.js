...
export default function Dashboard() {
  ...
  // Derived Active Classes (Only classes with admitted students)
  ...
  const [printIdCard, setPrintIdCard] = useState(false); // PVC Print Mode
        ...
        <div className="fixed inset-0 bg-slate-900/95 z-50 flex items-center justify-center p-4">
          <style jsx global>{`
            @media print {
              ...
              body, html { width: 54mm; height: 86mm; background: white; margin: 0; padding: 0; }
              .no-print { display: none !important; }
              .pvc-card { width: 54mm !important; height: 86mm !important; border: none !important; border-radius: 0 !important; margin: 0 !important; padding: 4mm !important; box-sizing: border-box !important; }
            }
          `}</style>
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto w-full">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="bg-slate-900/60 border border-slate-800/80 p-6 md:p-8 rounded-2xl shadow-xl">
              ...
              <form onSubmit={handleSaveStudent} className="space-y-6">
                ...
                {/* Horizontal Class Selection for Admission */}
                <div>
        ...
        {activeTab === 'class_mgmt' && (
          <div className="space-y-6 animate-fade-in w-full">
            ...
            {/* Horizontal Class Tabs for Mgmt */}
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
              {classList.map(cls => (
            ...
            {!showOnlyPendingList ? (
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4 space-y-6">
                  ...
                  {/* Two-Step Selector (Horizontal Classes) */}
