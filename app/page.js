...
export default function Dashboard() {
  ...
  const handleToggleStaffLoginAccess = async (stf) => {
    ...
    if (!error) {
      showToast(
        newStatus === 'Active' 
          ? `${stf.name} এর লগইন অ্যাক্সেস চালু (Active) করা হয়েছে!` 
          : `${stf.name} এর লগইন অ্যাক্সেস বন্ধ (Inactive) করা হয়েছে!`,
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-slate-950 animated-mesh-bg text-slate-100 font-sans relative overflow-hidden">
      ...
      {/* 4. OFFICIAL NOTICE PRINT MODAL (RESTORED) */}
      ...
      {/* 5. STATUS CHANGE / TRANSFER OUT MODAL (RESTORED) */}
      {statusModalStudent && (
        <div className="fixed inset-0 bg-slate-950/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
      ...
      {/* 6. TRANSFER CERTIFICATE (TC) PRINT MODAL (RESTORED) */}
      {tcPrintData && (
        <div className="fixed inset-0 bg-white text-slate-900 z-50 p-6 overflow-y-auto print:p-0">
      ...
      {/* 7. EDIT ERP TRANSACTION MODAL (RESTORED) */}
      {editingTx && (
        <div className="fixed inset-0 bg-slate-950/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900/90 border border-white/10 p-6 rounded-3xl max-w-sm w-full shadow-2xl relative backdrop-blur-2xl">
      ...
      {/* 8. STUDENT CONTACT DETAILS MODAL (RESTORED) */}
      {contactModalStudent && (
      ...
      {/* 9. PRINTABLE MONEY RECEIPT MODAL (RESTORED) */}
      {receiptData && (
        <div className="fixed inset-0 bg-white text-slate-900 z-50 p-6 overflow-y-auto print:p-0">
      ...
      {/* 10. PVC ID CARD PRINT MODAL (RESTORED) */}
